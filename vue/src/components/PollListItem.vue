<template>
    ...
    >
        <img :src="poll.image_url" alt="" class="w-full h-48 object-cover">
        <h4 class="mt-4 text-lg font-bold">{{poll.title}}</h4>
        <div v-html="poll.description" class="overflow-hidden flex-1"></div>
        <div class="flex justify-between items-center mt-3">
            <router-link :to="{ name: 'pollView', params: {id: poll.id}}"
